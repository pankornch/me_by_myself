...
const EditProfilePage: NextPage = () => {
	...
	return (
		<Layout navbarType="ACCOUNT">
			<div className="pt-32 sm:w-2/3 lg:w-1/2 m-auto">
				...
				<div className="flex flex-col gap-y-2">
					<Input
						...
						validate={(value) => {
							if (value.length !== 10)
								return "กรุณากรอกข้อมูลเบอร์โทรให้ถูกต้อง"
						}}
				...
				<button
					onClick={router.back}
					className="flex justify-center items-center py-2 rounded-full bg-gray-400 w-full text-center text-white font-medium mt-6 hover:scale-105"
				>
					ยกเลิก
				</button>
			</div>
